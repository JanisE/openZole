 ...
 * @return {{oPlayerOrder: {PlayerOrder}, oGameState: {GameState}, oResult: {oChips: {A: {int}, B: {int}, C: {int}}, oDetails: {oGameChips, oPuleChips: Object}}}}
 */
...
GameRun.prototype.Export = function GameRun_Export ()
{
	...
	for (const oGame of this.aGames) {
		oGameRunSerialised.aGames.push({
			oPlayerOrder: oGame.oPlayerOrder.Export(),
