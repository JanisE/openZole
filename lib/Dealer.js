...
//	console.log(this.oGameState.ExportLog());
//	console.log(JSON.stringify(this.oGameState.ExportLog()));
//	console.log(CalculateChips(this.oGameState), this.oGameState.sGameMode, this.oGameState.sGameModeBy);
//	console.log(JSON.stringify(this.oGameState.oStats));

	const oGameChips = CalculateChips(this.oGameState);

	this.oGameRun.AddGame(
		this.oPlayerOrder,
		this.oGameState,
		_.cloneDeep(oGameChips)	// TODO How to include pule chips?
	);

	this.oUiAdapter.AddGameChipsToResult(oGameChips)
	.then(() =>
	{
