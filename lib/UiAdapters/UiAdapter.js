...
UiAdapter.prototype.Notice = function UiAdapter_Notice (sMessage)
{
	console.log(sMessage);
};

UiAdapter.prototype.PresentGameModeOptions = function PresentGameModeOptions ()
{
 ...
 * {Promise} UI updated.
 */
UiAdapter.prototype.OnGameOver = function UiAdapter_OnGameOver (oGame)
{
	return Promise.resolve();
};
